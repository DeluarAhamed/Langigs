    ...
    <section className="overflow-hidden px-[5%] py-16 md:py-24 lg:py-28 scheme-2">
      <div className="container">
        <div className="mb-12 w-full max-w-lg md:mb-18 lg:mb-20">
          <h2 className="mb-5 text-h2 font-bold md:mb-6">Trusted results</h2>
          <p className="text-medium">
            A single partner for complex multilingual projects across Africa.
          </p>
        </div>
        <Carousel
              ...
              <CarouselItem className="pl-0 lg:basis-1/2 lg:pr-16">
                <div className="mx-auto flex h-full max-w-lg flex-col justify-center">
                  ...
                  <h5 className="text-h6 font-bold">
                    "We handed them a mess of audio in three dialects and they
                    returned clean transcripts and a translated report. One
                    partner, no excuses."
                  </h5>
                  <div className="mt-6 flex w-full flex-col gap-5 md:mt-8 md:w-auto md:flex-row md:items-center md:text-left">
                    ...
                    <div className="mb-4 md:mb-0">
                      <p className="font-semibold">Amina Wanjiru</p>
                      <p>Research Lead, Twaweza</p>
                    </div>
