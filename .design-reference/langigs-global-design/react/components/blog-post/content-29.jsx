    ...
    <section className="px-[5%] py-16 md:py-24 lg:py-28 scheme-2">
      <div className="container">
        <div className="mx-auto max-w-lg">
          ...
          <div className="my-8 h-px bg-scheme-border md:my-12" />
          <div className="flex items-center gap-4">
            ...
            <div className="grow">
              <p className="text-medium font-semibold">Amara Diallo</p>
              <p>Founder, Langigs Global</p>
            </div>
          </div>
        </div>
      </div>
