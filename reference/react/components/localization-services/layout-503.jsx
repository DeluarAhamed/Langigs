        ...
        <div className="mb-12 md:mb-18 lg:mb-20">
          <div className="mx-auto max-w-lg text-center">
            ...
            <p className="text-medium">
              Every project passes through a multi-layered review. Native
              linguists, cultural consultants, and a dedicated project manager
              ensure the work is contextually flawless.
            </p>
          ...
          >
            <Card className="grid grid-cols-1 md:grid-cols-2 md:items-center">
              <div className="p-6 md:p-8 lg:p-12">
                <p className="mb-3 font-semibold md:mb-4">Linguists</p>
                <h2 className="mb-5 text-h3 font-bold md:mb-6">
                  In-market native experts handle every translated string
                </h2>
                <p>
                  Our linguists live where your users live. They catch what
                  machines and distant translators miss.
                </p>
