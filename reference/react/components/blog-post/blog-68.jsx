        ...
        <div className="md:mb-18 mb-12 grid grid-cols-1 items-start justify-start gap-y-8 md:grid-cols-[1fr_max-content] md:items-end md:justify-between md:gap-x-12 md:gap-y-4 lg:mb-20 lg:gap-x-20">
          <div className="md:mr-12 lg:mr-0">
            <div className="w-full max-w-lg">
              ...
              <h2 className="text-h2 mb-3 font-bold md:mb-4">Keep reading</h2>
              <p className="text-medium">
                More stories from the frontiers of language and technology
              </p>
            </div>
          </div>
                ...
                >
                  ...
                  <div className="px-5 py-6 md:p-6">
                    ...
                    <h2 className="text-h5 mb-2 font-bold">
                      Why machine translation fails the African market
                    </h2>
                    <p>
                      A blunt look at the cost of ignoring cultural nuance in
              ...
              <Card>
                ...
                >
                  ...
                  <div className="px-5 py-6 md:p-6">
                    ...
                    <h2 className="text-h5 mb-2 font-bold">
                      The human layer your AI model is missing
                    </h2>
                    <p>
                      How native speakers catch the edge cases your training
                      data overlooks
                    </p>
                    <Button
                      title="Read more"
              ...
              <Card>
                ...
                >
                  ...
                  <div className="px-5 py-6 md:p-6">
                    ...
                    <h2 className="text-h5 mb-2 font-bold">
                      A field guide to multilingual data collection
                    </h2>
                    <p>
                      What we learned gathering voice samples across eight
                      countries in one quarter
                    </p>
                    <Button
                      title="Read more"
                      variant="link"
              ...
              <Card>
                ...
                >
                  ...
                  <div className="px-5 py-6 md:p-6">
                    ...
                    <h2 className="text-h5 mb-2 font-bold">
                      Trust is a language few companies speak fluently
                    </h2>
                    <p>
                      How a bad translation cost one NGO a year of fieldwork
                    </p>
                    <Button
                      title="Read more"
                      variant="link"
              ...
              <Card>
                ...
                >
                  ...
                  <div className="px-5 py-6 md:p-6">
                    ...
                    <h2 className="text-h5 mb-2 font-bold">
                      Recording the oral histories of a continent
                    </h2>
                    <p>
                      The quiet, urgent work of preserving language before it
                      disappears
                    </p>
                    <Button
                      title="Read more"
              ...
              <Card>
                ...
                >
                  ...
                  <div className="px-5 py-6 md:p-6">
                    ...
                    <h2 className="text-h5 mb-2 font-bold">
                      The quiet precision of a good translator
                    </h2>
                    <p>
                      Why the best work is invisible and that is the entire
                      point
                    </p>
                    <Button
                      title="Read more"
